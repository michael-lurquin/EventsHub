...
@section('content')
    <div class="bg-white">
        <!-- Header -->
        <div class="relative bg-gray-800 pb-56">
            ...
            <div class="relative mx-auto max-w-7xl py-24 px-4 sm:py-56 sm:px-6 lg:px-8">
                <h1 class="text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl">{{ config('app.name') }}</h1>
        ...
        <!-- Overlapping cards -->
        <section class="relative z-10 mx-auto -mt-56 max-w-7xl px-4 pb-56 sm:px-6 lg:px-8" aria-labelledby="contact-heading">
            ...
            <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
                <div class="flex flex-col rounded-2xl bg-white shadow-xl">
                    <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                        <div class="absolute top-0 inline-block -translate-y-1/2 transform rounded-xl bg-primary-600 p-5 shadow-lg">
                    ...
                    <div class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8">
                        <a href="#" class="text-base font-medium text-primary-700 hover:text-primary-600">Contact us<span aria-hidden="true"> &rarr;</span></a>
                    </div>
                </div>
