    ...
    <div class="mx-auto max-w-7xl py-6">
        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
            ...
            <div class="text-center bg-white px-4 py-5 sm:px-6 shadow rounded-lg">
                ...
                <div class="mt-4">
                    <a href="{{ route('admin.users.create', ['tenant_id' => $tenant->id]) }}" class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
