...
<div>
    ...
    <div class="relative mt-1 flex rounded-md shadow-sm">
        ...
        @if ( !empty($disabled) && $disabled )
            {!! Form::password($fieldname, ['class' => $class, 'id' => $fieldname, 'autocomplete' => $autocomplete, 'placeholder' => $placeholder, 'disabled' => 'disabled']) !!}
        @else
            {!! Form::password($fieldname, ['class' => $class, 'id' => $fieldname, 'autocomplete' => $autocomplete, 'placeholder' => $placeholder]) !!}
        @endif
