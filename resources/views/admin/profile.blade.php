...
@section('content')
                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    <label for="email-address" class="block text-sm text-gray-700">Email address</label>
                                ...
                                <div class="col-span-6">
                                    <label for="street-address" class="block text-sm text-gray-700">Street address</label>
                                ...
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                    <label for="region" class="block text-sm text-gray-700">State / Province</label>
                                ...
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                    <label for="postal-code" class="block text-sm text-gray-700">ZIP / Postal code</label>
    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">Notifications</h3>
                    ...
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <fieldset>
                                ...
                                <div class="text-base text-gray-700 font-medium" aria-hidden="true">By Email</div>
                            ...
                            <fieldset>
                                <legend class="contents text-base text-gray-700 font-medium">Push Notifications</legend>
                                ...
                                <div class="mt-4 space-y-4">
                                    <div class="flex items-center">
                                        ...
                                        <label for="push-everything" class="ml-3 block text-sm text-gray-700">Everything</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="push-email" class="ml-3 block text-sm text-gray-700">Same as email</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="push-nothing" class="ml-3 block text-sm text-gray-700">No push notifications</label>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
