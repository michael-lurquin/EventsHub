    ...
    <div class="mt-4">
        ...
        <div class="hidden sm:block">
            <nav class="-mb-px flex space-x-8">
                ...
                >
                    <span>All</span>
                    <span class="{{ $currentTab === 'all' ? 'bg-primary-100 text-primary-600' : 'bg-gray-50 text-gray-400' }} hidden ml-3 py-0.5 px-2.5 rounded-full text-xs font-medium md:inline-block">{{ $users['all']->total() }}</span>
                </a>
                <a
                    href="{{ route('admin.users.index', ['currentTab' => 'trash']) }}" 
                ...
                >
                    ...
                    <span>Trash</span>
                    <span class="{{ $currentTab === 'trash' ? 'bg-primary-100 text-primary-600' : 'bg-gray-50 text-gray-400' }} hidden ml-3 py-0.5 px-2.5 rounded-full text-xs font-medium md:inline-block">{{ $users['trash']->total() }}</span>
                </a>
            </nav>
        </div>
    </div>
