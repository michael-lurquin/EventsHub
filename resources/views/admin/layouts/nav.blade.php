@if ( $mobile )
    ...
    <a href="{{ route('admin.users.index', ['currentTab' => 'all']) }}" class="{{ request()->routeIs('admin.users.*') ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700' }} block px-3 py-2 rounded-md text-base font-medium">Users</a>
...
@else
    ...
    <a href="{{ route('admin.users.index', ['currentTab' => 'all']) }}" class="{{ request()->routeIs('admin.users.*') ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700' }} px-3 py-2 rounded-md text-sm font-medium">Users</a>
